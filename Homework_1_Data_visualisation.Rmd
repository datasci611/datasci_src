...
6.  Recreate the R code necessary to generate the following graphs.
    ...
    ![Smooth lines for each `drv`](HW1P0306A.png)
    ...
    ![A single smooth line, transparency by `year`](HW1P0306B.png)
    ...
    ![Layered dots and an additional text information](HW1P0306C.png)
